...
<div class="page-header d-flex align-items-center justify-content-between mb-4">
    <div>
        <h1>Lowongan Kerja</h1>
        <p class="text-muted mb-0">Kelola, edit, dan validasi status lowongan untuk alumni.</p>
    </div>
    ...
    <div class="card-body">
        <form action="{{ route('admin.lowongan.index') }}" method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-md-2 d-flex gap-2">
                ...
                <a href="{{ route('admin.lowongan.index') }}" class="btn btn-outline-secondary flex-fill"><i class="fas fa-times"></i></a>
            </div>
        </form>
    </div>
</div>
...
<div class="card">
    <div class="card-header bg-white d-flex justify-content-between align-items-center">
        <span class="fw-semibold"><i class="fas fa-briefcase me-2 text-success"></i>Daftar Lowongan</span>
        <span class="badge bg-secondary">{{ $lowongans->total() }} data</span>
    </div>
    <div class="table-responsive">
...
@endsection 
    @if ($lowongans->hasPages())
        <div class="card-footer bg-white">{{ $lowongans->links() }}</div>
    @endif
</div>
@endsection
